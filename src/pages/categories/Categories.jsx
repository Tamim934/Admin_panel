...
getBrands()
  ...
  <Typography variant="h3" component="h2" gutterBottom style={{ color: '#3f51b5', textAlign: 'center' }}>
    🌈 Navigate the Spectrum of Categories 🌈
  </Typography>
  <Typography variant="body1" gutterBottom style={{ textAlign: 'center' }}>
    Welcome to our categories page, your compass in the world of shopping. From fashion to electronics, home decor to sports gear, our categories cover a wide spectrum. Find your path to the perfect product here!
  </Typography>
</div>
...
/>
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle>Add a Catagories</DialogTitle>
        <DialogContent>
          <TextField
            autoFocus
            margin="dense"
      ...
      <div className='mt-[20px] max:flex-wrap'>
